"""
streamlit_app.py — Entrypoint de la app web: login + Dashboard ejecutivo.
Portado de TabDashboard en app/main.py (Fase 6), con la capa visual
rediseñada segun el diseño ejecutivo entregado por el usuario (HTML/CSS
puro, sin Plotly/Chart.js/canvas) -- ver core/dashboard_html.py.
...
username, rol, nombre = auth.require_login()
